...
- $templateRoute: es la ruta de la platilla del partial.
...
__OJO!__ Actualemente un partial interno no "hereda" las variables del partial contedor, sólo las de la vista contenedora.
